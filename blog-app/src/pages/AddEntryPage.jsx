...
const AddEntryPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("http://65.2.128.22:5000/entries", formData, {
        headers: {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
      ...
      <div className="flex items-start justify-center pt-10 pb-10 px-4">
        <div className="w-full max-w-2xl bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
          <h1 className="text-3xl font-serif font-bold text-indigo-700 mb-6">
            New Journal Entry
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg p-3 text-gray-800 focus:ring-indigo-500 focus:border-indigo-500"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  className="w-full appearance-none bg-white border border-gray-300 rounded-lg pl-10 pr-10 py-3 text-lg text-gray-800 focus:ring-indigo-500 focus:border-indigo-500"
                >
                  {moods.map((m) => (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-gray-300 rounded-lg p-3 text-gray-800 focus:ring-indigo-500 focus:border-indigo-500 resize-y"
                required
              />
            </div>
